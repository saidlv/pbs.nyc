                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item hasan"><a class="nav-link active" href="#anatablo" data-toggle="tab">DOB Complaints</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="resultstable" data-order='[[ 1, "desc" ]]'
                                    ...
                                    @foreach($properties as $property)
                                        @foreach($property->dobComplaints as $item)
                                            @if ($item->inspectionDate() && $item->inspectionDate()>(now()->addMonths(-1)))
                                                <tr>
                                                    <td> {{$property->house_number}} {{$property->stname}}</td>
                                                    <td>{{$item->status}}</td>
                                                    <td>{{$item->inspectionDate()}}</td>
