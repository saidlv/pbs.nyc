...
@section('title', 'PBS Portal | Create Newsletter Campaign')
@section('meta_description', 'Create new newsletter campaigns for property management communications in the PBS Portal.')

@section('plugins.Summernote', true)

{{--@section('content_header')--}}
{{--    <h1 class="m-0 text-dark">Create New Campaigns</h1>--}}
{{--@stop--}}
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                {!! Form::open(['route' => 'campaign.store','files'=>'true','class'=>'col-12']) !!}
                <div class="form-group">
                    {!! Form::label('title', 'Campaign Title', ['class' => 'control-label']) !!}
