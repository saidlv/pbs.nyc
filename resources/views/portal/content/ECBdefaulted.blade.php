...
@section('title', 'PBS Portal | ECB Defaulted')
@section('meta_description', 'Monitor and manage defaulted ECB violations for your properties in the PBS Portal.')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">ECB Defaulted</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="resultstable" data-order='[[ 1, "desc" ]]' class="table table-bordered table-striped"
                            ...
                            @foreach($properties as $property)
                                @foreach($property->oathHearings as $item)
                                    @if(Str::contains($item->hearing_result, 'Defaulted') || Str::contains($item->hearing_result, 'DEFAULTED') || Str::contains($item->hearing_result, 'defaulted'))
                                        <tr>
