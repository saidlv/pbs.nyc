                ...
                <tr>
                    <td>
                        <table class="renklendir"
                            ...
                            @endif
                            @if ($item->job_status_descrp)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Status
                                    </td>
                                    <td>
                                        @if(isset($changes['job_status_descrp']))
                                            <i color="red"><s>{{$changes['job_status_descrp']}}</s></i> / @endif
                                        {{$item->job_status_descrp}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->latestActionDate())
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Latest Action Date
                                    </td>
                                    <td>
                                        @if(isset($changes['latest_action_date']))
                                            <i color="red"><s>{{$changes['latest_action_date']}}</s></i> / @endif
                            ...
                            @if ($item->job_description)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['job_description']))
                                            <i color="red"><s>{{$changes['job_description']}}</s></i> / @endif
