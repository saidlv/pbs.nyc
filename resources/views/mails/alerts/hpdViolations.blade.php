                        ...
                        <table class="renklendir"
                            ...
                            @if ($item->violationid)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['violationid']))
                                            <i color="red"><s>{{$changes['violationid']}}</s></i> / @endif
                                        {{$item->violationid}}
                                    </td>
                                </tr>
                            @endif
                                ...
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['class']))
                                            <i color="red"><s>{{$changes['class']}}</s></i> / @endif
                                        {{$item->class}}
                                    </td>
                                </tr>
                            @endif
                            @if (isset($item->inspectiondate))
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Inspection Date
                                    </td>
                                    <td>
                                        @if(isset($changes['inspectiondate']))
                                            <i color="red"><s>{{$changes['inspectiondate']}}</s></i> / @endif
                                        {{$item->inspectiondate()}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->novdescription)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Nov Description
                                    </td>
                                    <td>
                                        @if(isset($changes['novdescription']))
                                            <i color="red"><s>{{$changes['novdescription']}}</s></i> / @endif
                                        {{$item->novdescription}}
                                    </td>
                                </tr>
                            @endif
                            @if (isset($item->novissueddate))
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Nov Issued Date
                                    </td>
                                    <td>
                                        @if(isset($changes['novissueddate']))
                                            <i color="red"><s>{{$changes['novissueddate']}}</s></i> / @endif
                                        {{$item->novissuedDate()}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->violationstatus)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Violation Status
                                    </td>
                                    <td>
                                        @if(isset($changes['violationstatus']))
                                            <i color="red"><s>{{$changes['violationstatus']}}</s></i> / @endif
                                ...
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['currentstatus']))
                                            <i color="red"><s>{{$changes['currentstatus']}}</s></i> / @endif
                                        {{$item->currentstatus}}
                                    </td>
                                </tr>
                            @endif
