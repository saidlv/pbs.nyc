                ...
                <tr>
                    <td>
                        <table class="renklendir"
                            ...
                            @endif
                            @if ($item->permittee_s_license_type)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Permit License
                                    </td>
                                    <td>
                                        @if(isset($changes['permittee_s_license_type']))
                                            <i color="red"><s>{{$changes['permittee_s_license_type']}}</s></i> / @endif
                                        {{$item->permittee_s_license_type}}
                                    </td>
                                </tr>
                            @endif
                            ...
                            @if ($item->issuedDate())
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['issued_date']))
                                            <i color="red"><s>{{$changes['issued_date']}}</s></i> / @endif
                                        {{$item->issuedDate()}}
                                    </td>
                                </tr>
                            @endif
