                        ...
                        <table class="renklendir"
                            ...
                            @if ($item->cof_num)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['cof_num']))
                                            <i color="red"><s>{{$changes['cof_num']}}</s></i> / @endif
                                        {{$item->cof_num}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->cof_type)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['cof_type']))
                                            <i color="red"><s>{{$changes['cof_type']}}</s></i> / @endif
                                        {{$item->cof_type}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->holder_name)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['holder_name']))
                                            <i color="red"><s>{{$changes['holder_name']}}</s></i> / @endif
                                        {{$item->holder_name}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->expireDate())
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['expires_on']))
                                            <i color="red"><s>{{$changes['expires_on']}}</s></i> / @endif
                                        {{$item->expireDate()}}
                                    </td>
                                </tr>
                            @endif
