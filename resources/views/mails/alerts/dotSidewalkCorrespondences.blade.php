                        ...
                        <table class="renklendir"
                                ...
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['issue']))
                                            <i color="red"><s>{{$changes['issue']}}</s></i> / @endif
                                        {{$item->issue}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->other_log)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['other_log']))
                                            <i color="red"><s>{{$changes['other_log']}}</s></i> / @endif
                                        {{$item->other_log}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->dateReceived())
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['date_received']))
                                            <i color="red"><s>{{$changes['date_received']}}</s></i> / @endif
                                        {{$item->dateReceived()}}
                                    </td>
                                </tr>
                            @endif
