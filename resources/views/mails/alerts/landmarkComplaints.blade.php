                        ...
                        <table class="renklendir"
                            ...
                            @if ($item->action_taken)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['action_taken']))
                                            <i color="red"><s>{{$changes['action_taken']}}</s></i> / @endif
                                        {{$item->action_taken}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->work_reported)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Work Reported
                                    </td>
                                    <td>
                                        @if(isset($changes['work_reported']))
                                            <i color="red"><s>{{$changes['work_reported']}}</s></i> / @endif
                                        {{$item->work_reported}}
                                    </td>
                                </tr>
                            @endif
