    ...
    <tr>
        <td class="td container"
            ...
            <table class="bizimfont anatablo renklendir" width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td bgcolor="#f2f2f2" style="font-size:18px; line-height:25px; text-align:center;">
                        <span>
                        ...
                        <table class="renklendir"
                            ...
                            @if ($item->filedDate())
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['filed']))
                                            <i color="red"><s>{{$changes['filed']}}</s></i> / @endif
                                        {{$item->filedDate()}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->application)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['application']))
                                            <i color="red"><s>{{$changes['application']}}</s></i> / @endif
                                        {{$item->application}}
                                    </td>
                                </tr>
                            @endif
                            @if ($item->calendar)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['calendar']))
                                            <i color="red"><s>{{$changes['calendar']}}</s></i> / @endif
                                        {{$item->calendar}}
                                    </td>
                                </tr>
                            @endif
                                ...
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['date']))
                                            <i color="red"><s>{{$changes['date']}}</s></i> / @endif
                                        {{$item->date()}}
                                    </td>
                                </tr>
                            @endif
