                ...
                <tr>
                    <td>
                        <table class="renklendir"
                            ...
                            @endif
                            @if ($item->violation_class)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    <td>
                                        Violation class
                                    </td>
                                    <td>
                                        @if(isset($changes['violation_class']))
                                            <i color="red"><s>{{$changes['violation_class']}}</s></i> / @endif
                            ...
                            @if ($item->rescinded)
                                <tr @if($i++%2) bgcolor="#f2f2f2" @else bgcolor="#fcfcfc" @endif>
                                    ...
                                    <td>
                                        @if(isset($changes['rescinded']))
                                            <i color="red"><s>{{$changes['rescinded']}}</s></i> / @endif
                                        {{$item->rescinded}}
                                    </td>
                                </tr>
                            @endif
