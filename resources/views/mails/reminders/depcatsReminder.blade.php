                ...
                <tr bgcolor="#f2f2f2">
                    <td style="font-size:18px; line-height:25px; text-align:center;">
                        <span>
                            ...
                            <br/><span style="color: darkred; font-size:18px; padding-top: 2px">Remaining Inspection:
                                <u>
                                    {{\Carbon\Carbon::parse($item->expirationdate)->longRelativeToNowDiffForHumans(\Carbon\Carbon::now())}}
                                </u></span><br/><br/>
                        </span>
                    </td>
                </tr>
