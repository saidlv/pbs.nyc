...
return [
    ...
    */
    ...
    'rolesMiddlware' => env('LARAVEL_LOGGER_ROLES_MIDDLWARE', 'role:developer'),
    ...
    */
    ...
    'loggerBladeExtended'       => env('LARAVEL_LOGGER_LAYOUT', 'portal.app'),
    ...
    'bladePlacementJs'          => env('LARAVEL_LOGGER_BLADE_PLACEMENT_JS', 'js'),
